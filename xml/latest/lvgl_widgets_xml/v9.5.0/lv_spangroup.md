```xml title="lvgl_widgets_xml/v9.5.0/lv_spangroup.xml" source="https://github.com/lvgl/lvgl_pro/blob/9bccbd4302cf1f425d2a9790d8b6133170e81650/lvgl_widgets_xml/v9.5.0/lv_spangroup.xml"
<!--
Example
...
<widget>
    <api>
        ...
        <parts>
            <part name="main" help="Style the text block and its background: text and background properties. Style individual spans via each span's own `style`."/>
        </parts>
    </api>
</widget>
```
