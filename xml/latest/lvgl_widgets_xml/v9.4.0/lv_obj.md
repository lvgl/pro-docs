```xml title="lvgl_widgets_xml/v9.4.0/lv_obj.xml" source="https://github.com/lvgl/lvgl_pro/blob/64ebc7a7b6db60ed63db7ca4dae1573c702c882a/lvgl_widgets_xml/v9.4.0/lv_obj.xml"
<!--
Example
...
<widget>
	<api>
       ...
       <element name="style" access="add" type="void" help="Add a style to the widget">
        ...
        <prop name="style_x-selector" type="px|%" help="Set X position (px or %)"/>
        <prop name="style_y-selector" type="px|%" help="Set Y position (px or %)"/>
        <prop name="style_height-selector" type="px|%|content" help="Set height (px, %, or content)"/>
        <prop name="style_min_height-selector" type="px|%" help="Set min height (px or %)"/>
        <prop name="style_max_height-selector" type="px|%" help="Set max height (px or %)"/>
        <prop name="style_width-selector" type="px|%|content" help="Set width (px, %, or content)"/>
        <prop name="style_min_width-selector" type="px|%" help="Set min width (px or %)"/>
        <prop name="style_max_width-selector" type="px|%" help="Set max width (px or %)"/>
        <prop name="style_length-selector" type="px|%" help="Set length (used by some widgets)"/>
        ...
        <prop name="style_blur_radius-selector" type="int" help="The radius of the blurring"/>
        <prop name="style_blur_quality-selector" type="enum:lv_blur_quality" help="Set whether to prefer speed or precision"/>
        <prop name="style_blur_backdrop-selector" type="bool" help="true: blur the background first, false: blur the widget"/>
