```xml title="lvgl_widgets_xml/v9.4.0/globals.xml" source="https://github.com/lvgl/lvgl_pro/blob/ccb93b776a23f6112f664d039e9d9181ef18a761/lvgl_widgets_xml/v9.4.0/globals.xml"
<api>
    ...
    <styledef>
        ...
        <prop name="min_height" type="px|%" help="Set min height (px or %)"/>
        <prop name="max_height" type="px|%" help="Set max height (px or %)"/>
        <prop name="width" type="px|%|content" help="Set width (px, %, or content)"/>
        <prop name="min_width" type="px|%" help="Set min width (px or %)"/>
        <prop name="max_width" type="px|%" help="Set max width (px or %)"/>
        <prop name="length" type="px|%" help="Set length (used by some widgets)"/>
        ...
        <prop name="blur_radius" type="int" help="The radius of the blurring"/>
        <prop name="blur_quality" type="enum:lv_blur_quality" help="Set whether to prefer speed or precision"/>
        <prop name="blur_backdrop" type="bool" help="true: blur the background first, false: blur the widget"/>
