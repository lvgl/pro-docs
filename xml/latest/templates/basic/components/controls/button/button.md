```xml title="templates/basic/components/controls/button/button.xml" source="https://github.com/lvgl/lvgl_pro/blob/3514c1eb6b7075d42b1ef8bd36931a525c3d56f3/templates/basic/components/controls/button/button.xml"
<component>
	<previews>
