```xml title="templates/basic/components/controls/button/button.xml" source="https://github.com/lvgl/lvgl_pro/blob/b50910a3acc7ed2355e2e41eabaca2630a9e383d/templates/basic/components/controls/button/button.xml"
<component>
	<previews>
