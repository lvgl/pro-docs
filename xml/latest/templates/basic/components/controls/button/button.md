```xml title="templates/basic/components/controls/button/button.xml" source="https://github.com/lvgl/lvgl_pro/blob/91553dccc827bdbb5d49302579f6a8df95e2db84/templates/basic/components/controls/button/button.xml"
<component>
	<previews>
