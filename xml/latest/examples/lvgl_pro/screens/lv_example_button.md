```xml title="examples/lvgl_pro/screens/lv_example_button.xml" source="https://github.com/lvgl/lvgl_pro/blob/4d05fc79f26b1a8daf2c0134018f3d07c6f19286/examples/lvgl_pro/screens/lv_example_button.xml"
<!--
 @title Button
...
<screen>
	<styles>
		...
		/>
		<!-- Pressed: darken -->
		<style name="style_btn_pressed" bg_color="0x1d4ed8" />
		<!-- Checked: accent -->
		<style name="style_btn_checked" bg_color="0x16a34a" />
	</styles>
	...
	>
		...
		<lv_button disabled="true" style_bg_opa="40%">
			<style name="style_btn" />
			<lv_label text="Disabled" />
		</lv_button>
	</view>
</screen>
```
