```xml title="examples/lvgl_pro/screens/lv_example_slider.xml" source="https://github.com/lvgl/lvgl_pro/blob/64ebc7a7b6db60ed63db7ca4dae1573c702c882a/examples/lvgl_pro/screens/lv_example_slider.xml"
<!--
 @title Slider
...
<screen>
	...
	<view>
		...
		<lv_label
			...
			y="-65"
			x="20"
			bind_text="subject_value"
			bind_text-fmt="%d %%"
			style_text_color="0x192e4f"
		/>
		...
		>
			...
			<style name="style_bar_knob" selector="knob" />
		</lv_slider>
