```xml title="examples/lvgl_open/screens/widgets/switch/lv_example_switch_styling.xml" source="https://github.com/lvgl/lvgl_pro/blob/91553dccc827bdbb5d49302579f6a8df95e2db84/examples/lvgl_open/screens/widgets/switch/lv_example_switch_styling.xml"
<!--
...
<screen>
	<styles>
		<style name="style_switch_main" bg_color="0xc4d8cb" bg_opa="100%" radius="999" pad_all="6" border_width="0" />
		<style name="style_switch_indicator_checked" bg_color="0x22c55e" bg_opa="100%" />
		<style
			name="style_switch_knob"
			bg_color="0xffffff"
			bg_opa="100%"
            pad_all="2"
			border_color="0xd1d5db"
			border_width="1"
	...
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center" style_pad_row="16">
		...
		<lv_switch name="sw_1" width="60" height="30">
			<style name="style_switch_main" selector="main" />
			<style name="style_switch_indicator_checked" selector="indicator|checked" />
			<style name="style_switch_knob" selector="knob" />
		</lv_switch>

		<lv_switch name="sw_2" width="60" height="30" checked="true">
			<style name="style_switch_main" selector="main" />
			<style name="style_switch_indicator_checked" selector="indicator|checked" />
			<style name="style_switch_knob" selector="knob" />
		</lv_switch>
