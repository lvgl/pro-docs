```xml title="examples/lvgl_open/screens/widgets/chart/lv_example_chart_series.xml" source="https://github.com/lvgl/lvgl_pro/blob/ccb93b776a23f6112f664d039e9d9181ef18a761/examples/lvgl_open/screens/widgets/chart/lv_example_chart_series.xml"
<!--
...
<screen>
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center" style_pad_row="16">
		...
		<lv_chart name="chart" width="90%" height="180" type="line" point_count="8">
			<!-- Temperature: left axis, 0..100 -->
			<lv_chart-series color="0xef4444" axis="primary_y" values="22 28 35 50 65 70 60 45" />
			<!-- Pressure: right axis, 0..2000 -->
			<lv_chart-series color="0x6366f1" axis="secondary_y" values="980 1100 1400 1600 1750 1850 1900 1700" />

			<lv_chart-axis axis="primary_y"   min_value="0" max_value="100" />
			<lv_chart-axis axis="secondary_y" min_value="0" max_value="2000" />
		</lv_chart>
	</view>
</screen>
```
