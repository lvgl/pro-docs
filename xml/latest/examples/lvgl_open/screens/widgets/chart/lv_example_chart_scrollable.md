```xml title="examples/lvgl_open/screens/widgets/chart/lv_example_chart_scrollable.xml" source="https://github.com/lvgl/lvgl_pro/blob/91553dccc827bdbb5d49302579f6a8df95e2db84/examples/lvgl_open/screens/widgets/chart/lv_example_chart_scrollable.xml"
<!--
...
<screen>
	...
	>
		...
		<lv_obj name="container_1" width="300" height="180" style_pad_all="0">
			...
			>
				<lv_chart
					...
					type="bar"
					point_count="12"
					hor_div_line_count="3"
					ver_div_line_count="0"
				>
					<lv_chart-series color="0x6366f1" axis="primary_y" values="32 41 38 55 62 70 65 58 47 60 75 80" />
				...
				<lv_scale
					...
					major_tick_every="1"
					label_show="true"
					text_src="'Jan' 'Feb' 'Mar' 'Apr' 'May' 'Jun' 'Jul' 'Aug' 'Sep' 'Oct' 'Nov' 'Dec'"
				/>
			</lv_obj>
		</lv_obj>
	</view>
