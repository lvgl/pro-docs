```xml title="examples/lvgl_open/screens/widgets/roller/lv_example_roller_styling.xml" source="https://github.com/lvgl/lvgl_pro/blob/4d05fc79f26b1a8daf2c0134018f3d07c6f19286/examples/lvgl_open/screens/widgets/roller/lv_example_roller_styling.xml"
<!--
...
<screen>
	<styles>
		<!-- Main: rounded card, soft background, muted unselected text, generous line space
		     (line space sets the gap *and* the selected-band height). -->
		<style
			name="style_roller_main"
			bg_color="0xf3f4f6"
			bg_opa="100%"
			radius="12"
			...
			text_line_space="20"
		/>
		<!-- Selected: accent fill, bold white text -->
		<style
			name="style_roller_selected"
			bg_color="0x6366f1"
			bg_opa="100%"
			text_color="0xffffff"
			text_font="font_example_large"
		/>
	</styles>
	...
	>
		...
		<lv_roller
			...
			selected="2"
		>
			<style name="style_roller_main" selector="main" />
			<style name="style_roller_selected" selector="selected" />
		</lv_roller>
	</view>
</screen>
```
