```xml title="examples/lvgl_open/screens/widgets/table/lv_example_table_rows_columns.xml" source="https://github.com/lvgl/lvgl_pro/blob/9bccbd4302cf1f425d2a9790d8b6133170e81650/examples/lvgl_open/screens/widgets/table/lv_example_table_rows_columns.xml"
<!--
...
<screen>
	<view>
		...
		<lv_table name="table" align="center" row_count="10" column_count="2" height="90%">
			<lv_table-cell row="0" column="0" value="A" />
			<lv_table-cell row="0" column="1" value="B" />
			<lv_table-cell row="2" column="1" value="middle" />
			<lv_table-cell row="8" column="0" value="8th" />
			<lv_table-cell row="9" column="0" value="last row" />
		</lv_table>
	</view>
</screen>
```
