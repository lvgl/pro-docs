```xml title="examples/lvgl_open/screens/widgets/scale/lv_example_scale_styling.xml" source="https://github.com/lvgl/lvgl_pro/blob/c4a99074ccc701fd983c2e1e0b01b1ba7645abe7/examples/lvgl_open/screens/widgets/scale/lv_example_scale_styling.xml"
<!--
 @title Scale styling
...
<screen>
	<styles>
		<style name="style_scale_main" line_color="0x6b7280" line_width="2" />
		<style name="style_scale_items" line_color="0x9ca3af" line_width="1" />
		<style
			name="style_scale_indicator"
			line_color="0x6366f1"
			line_width="3"
			text_color="0x6366f1"
	...
	>
		...
		<lv_scale
			...
			max_value="100"
		>
			<style name="style_scale_main" selector="main" />
			<style name="style_scale_items" selector="items" />
			<style name="style_scale_indicator" selector="indicator" />
		</lv_scale>
	</view>
</screen>
```
