```xml title="examples/lvgl_open/screens/layouts/flex/lv_example_flex_ignore_layout.xml" source="https://github.com/lvgl/lvgl_pro/blob/ccb93b776a23f6112f664d039e9d9181ef18a761/examples/lvgl_open/screens/layouts/flex/lv_example_flex_ignore_layout.xml"
<!--
...
<screen>
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center">
		...
		<lv_obj name="container" flex_flow="row" width="90%" height="150">
			<lv_button name="button_1" height="content">
				<lv_label name="label_1" text="Item A" align="center" />
			</lv_button>

			<!-- This item is invisible to flex. It centers itself by its own
			     align and does not occupy a flex slot. -->
			<lv_button name="button_2" align="center" ignore_layout="true" style_bg_color="0xe74c3c">
				<lv_label name="label_2" text="I'm Free!" align="center" />
			</lv_button>

			<lv_button name="button_3">
				<lv_label name="label_3" text="Item B" align="center" />
			</lv_button>

			<lv_button name="button_4" height="content">
				<lv_label name="label_4" text="Item C" align="center" />
			</lv_button>
		</lv_obj>
	</view>
</screen>
