```xml title="examples/lvgl_open/screens/layouts/grid/lv_example_grid_descriptors.xml" source="https://github.com/lvgl/lvgl_pro/blob/64ebc7a7b6db60ed63db7ca4dae1573c702c882a/examples/lvgl_open/screens/layouts/grid/lv_example_grid_descriptors.xml"
<!--
...
<screen>
	<view flex_flow="column" style_flex_main_place="center" style_flex_cross_place="center" style_flex_track_place="center">
		<!-- 💡 Adjust style_grid_column_dsc_array and style_grid_row_dsc_array to change fixed track sizes. -->
		<!-- Define 3 columns and 2 rows with fixed pixel sizes. -->
