```xml title="examples/lvgl_open/screens/layouts/grid/lv_example_grid_align.xml" source="https://github.com/lvgl/lvgl_pro/blob/3514c1eb6b7075d42b1ef8bd36931a525c3d56f3/examples/lvgl_open/screens/layouts/grid/lv_example_grid_align.xml"
<!--
...
<screen>
	...
	>
		...
		<!-- Track sizes are smaller than container, so alignment is visible. -->
		<!-- Grid container with explicit track alignment settings -->
		<lv_obj
			name="container"
			style_grid_column_dsc_array="56 56 56"
			style_grid_row_dsc_array="36 36"
			style_grid_column_align="start"
			style_grid_row_align="end"
			style_layout="grid"
			width="300"
			height="180"
		>
