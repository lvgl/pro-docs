```xml title="examples/lvgl_open/screens/styles/lv_example_style_outline.xml" source="https://github.com/lvgl/lvgl_pro/blob/9bccbd4302cf1f425d2a9790d8b6133170e81650/examples/lvgl_open/screens/styles/lv_example_style_outline.xml"
<!--
 @title Outline
...
<screen>
	...
	<styles>
		<!-- Detached focus ring 6 px outside the card -->
		<style
			name="style_focus"
			radius="14"
			bg_opa="100%"
	...
	<view>
		...
		<lv_obj name="container" align="center" width="200" height="120">
			<style name="style_focus" />
			<lv_label name="label" align="center" text="Focused" />
		</lv_obj>
	</view>
</screen>
```
