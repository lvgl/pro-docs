```xml title="examples/lvgl_open/screens/styles/lv_example_style_text.xml" source="https://github.com/lvgl/lvgl_pro/blob/4d05fc79f26b1a8daf2c0134018f3d07c6f19286/examples/lvgl_open/screens/styles/lv_example_style_text.xml"
<!--
 @title Text styling
...
<screen>
	...
	<styles>
		<!-- Card surface -->
		<style name="style_card" radius="16" bg_opa="100%" bg_color="0xffffff" pad_all="22" />
		<!-- The styled type itself -->
		<style
			name="style_heading"
			text_color="#accent"
			text_letter_space="4"
	...
	<view>
		...
		<lv_obj name="container" width="240" height="content" align="center">
			<style name="style_card" />
			<lv_label name="label" align="center" style_text_align="center" text="Custom&#10;Typography">
