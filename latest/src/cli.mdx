...
1. **Download** the latest CLI archive from the [Releases page](https://github.com/lvgl/lvgl_pro/releases) and unzip it.
...
jobs:
  ui-check:
    ...
    steps:
      ...
      - name: Download CLI
        # Latest Linux/macOS CLI build; see https://github.com/lvgl/lvgl_pro/releases for all assets
        run: |
          curl -L https://github.com/lvgl/lvgl_pro/releases/download/nightly/LVGL_Pro_CLI-nightly-linux-mac.zip -o lvgl-cli.zip
...
A full, working example lives in the [project's PR-check workflow](https://github.com/lvgl/lvgl_pro/blob/master/.github/workflows/pr-check.yml).
